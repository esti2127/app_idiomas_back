const queries = {
  ...
  insertQuestion: 'INSERT INTO questions (id_lesson, question_text, type) VALUES ($1, $2, $3) RETURNING *',
  ...
  updateQuestion: 'UPDATE questions SET id_lesson = $2, question_text = $3, type = $4 WHERE id_question = $1 RETURNING * ',
  ...
  WHERE questions.id_lesson = $1
  ORDER BY questions.id_question, answers.id_answer
`,
